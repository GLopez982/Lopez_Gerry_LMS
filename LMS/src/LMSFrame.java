/**
 * This is the GUI of the LMS (Library Management System) and the main class. This class is intended to allow the user to select from a menu
 ...
 */
 ...
 public class LMSFrame extends JFrame implements ActionListener {
      ...
      * functionality to the JComboBox and Submit button, allowing the user
      * to make choices from the menu options.
      *
      ...
      * Gathers a collection of book data retrieved from the database
      * catches an SQLException if a database access error occurs
      */
